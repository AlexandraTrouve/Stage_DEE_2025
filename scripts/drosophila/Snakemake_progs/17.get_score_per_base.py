...
path = "/Users/children/Desktop/Stage_2025/data/drosophila"
suffix = f".{score_type}27way.wigFix.bed.gz"
...
for chrom in sorted_bed_file.keys():
    score = f"{path}/drosophila_{score_type}_all_chr/{chrom}{suffix}"
