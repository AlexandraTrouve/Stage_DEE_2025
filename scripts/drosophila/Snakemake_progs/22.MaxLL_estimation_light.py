...
parser.add_argument("positive_selection_results")
...
pathMatrix = "/Users/children/Desktop/Stage_2025/data/drosophila/substitution_matrix"

sys.path.append("/Users/children/Desktop/Stage_2025/tools/")
import MLEvol as ML
import SVM
...
########################################################################################################################
Output_file = args.positive_selection_results

All_SVM_All_seq = pd.read_csv(args.all_deltaSVM_scores, sep='\t', header=0)
Obs_SVM_All_seq = pd.read_csv(args.focal_deltaSVM_scores, sep='\t', header=None, names=range(maxSub+4))
